  ...
  showNotification: function(from, align) {
    ...
    $.notify({
      icon: "nc-icon nc-bell-55",
        message: "\u00A1EVITA PAGOS DUPLICADO!, confirma con tu banco ante cualquier error al momento de pagar antes de intentar procesar el pago nuevamente. "
    ...
    showNotification1: function (from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-bell-55",
            message: "Si su pago fue descontado de su tarjeta y no lo ve aplicado en su matriculaci\u00F3n, al d\u00EDa siguiente se aplicar\u00EDa de forma autom\u00E1tica."
    ...
    showNotification2: function (from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-bell-55",
            message: "Tambi\u00E9n puedes pagar tu matriculaci\u00F3n a trav\u00E9s del Internet Banking del banco Popular!!! "
